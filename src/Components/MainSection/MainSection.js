...
function MainSection({ covidDataMain }) {
	const confirmedCases = covidDataMain.Global.TotalConfirmed;
	const recoveredCases = covidDataMain.Global.TotalRecovered;
	const deathCases = covidDataMain.Global.TotalDeaths;
